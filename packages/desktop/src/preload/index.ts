...
const api: ElectronAPI = {
  ...
  getLanConfig: () => ipcRenderer.invoke("get-lan-config"),
  setLanConfig: (config) => ipcRenderer.invoke("set-lan-config", config),
  ...
  writeClipboardText: (value) => ipcRenderer.invoke("write-clipboard-text", value),
