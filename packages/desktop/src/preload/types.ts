...
import type { WslServersPlatform } from "@newhorse/app/wsl/types"
...
export type ElectronAPI = {
  ...
  saveTextFile: (opts: { title?: string; defaultPath?: string; contents: string }) => Promise<string | null>
