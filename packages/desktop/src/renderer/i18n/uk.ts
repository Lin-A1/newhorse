export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію newhorse",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} newhorse завантажено. Бажаєте встановити її та перезапустити?",
