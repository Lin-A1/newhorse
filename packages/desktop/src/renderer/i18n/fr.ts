export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'newhorse",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'newhorse a été téléchargée. Voulez-vous l'installer et redémarrer ?",
