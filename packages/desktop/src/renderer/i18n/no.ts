export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av newhorse",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av newhorse er lastet ned. Vil du installere den og starte på nytt?",
