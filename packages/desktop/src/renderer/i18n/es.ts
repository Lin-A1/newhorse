export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de newhorse",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de newhorse. ¿Quieres instalarla y reiniciar?",
