export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji newhorse",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} newhorse. Czy chcesz ją zainstalować i uruchomić ponownie?",
