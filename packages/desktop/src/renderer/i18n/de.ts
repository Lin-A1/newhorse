export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von newhorse",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von newhorse wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
