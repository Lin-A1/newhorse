...
export const Definitions = {
  ...
  "dialog.memory.accept": keybind("alt+a", "Accept Memory proposal"),
  "dialog.memory.reject": keybind("alt+r", "Reject Memory proposal"),
  "dialog.memory.edit": keybind("alt+e", "Edit Memory record"),
  "dialog.memory.pause": keybind("alt+p", "Pause or resume Memory record"),
  "dialog.memory.delete": keybind("alt+d", "Delete Memory record"),
  "dialog.memory.export": keybind("alt+x", "Copy Memory export to clipboard"),
  "dialog.memory.clear": keybind("alt+c", "Clear scoped Memory"),
  "dialog.continuity.approve": keybind("alt+a", "Approve continuity grant"),
  "dialog.continuity.revoke": keybind("alt+r", "Revoke continuity grant"),
