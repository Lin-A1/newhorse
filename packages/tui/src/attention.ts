...
} from "@newhorse/plugin/tui"
import { AttentionSoundName, type TuiConfig } from "./config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
import defaultSoundPath from "@newhorse/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@newhorse/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@newhorse/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@newhorse/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@newhorse/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@newhorse/ui/audio/yup-01.mp3" with { type: "file" }
