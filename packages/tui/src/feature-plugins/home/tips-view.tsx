...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent newhorse from reading sensitive files",
  "Use {highlight}nh run{/highlight} for non-interactive scripting",
  "Use {highlight}nh --continue{/highlight} to resume the last session",
  "Use {highlight}nh run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}nh serve{/highlight} for headless API access to newhorse",
  "Use {highlight}nh run --attach{/highlight} to connect to a running server",
  "Run {highlight}nh upgrade{/highlight} to update to the latest version",
  "Run {highlight}nh auth list{/highlight} to see all configured providers",
  "Run {highlight}nh agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}nh github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}nh debug config{/highlight} to troubleshoot configuration",
