...
import { Splash } from "@newhorse/ui/logo"
import { ThemeProvider } from "@newhorse/ui/theme/context"
...
function BodyDesignClass() {
  ...
  createRenderEffect(() => {
    ...
    // newhorse always runs the v2 layout (the legacy interface is retired).
