...
beforeAll(async () => {
  ...
  mock.module("@newhorse/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@newhorse/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@newhorse/ui/icon", () => ({ Icon: () => null }))
  mock.module("@newhorse/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
