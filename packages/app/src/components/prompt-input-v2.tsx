import { ImagePreview } from "@newhorse/ui/image-preview"
...
import { Icon } from "@newhorse/ui/v2/icon"
import { KeybindV2 } from "@newhorse/ui/v2/keybind-v2"
import { TooltipV2 } from "@newhorse/ui/v2/tooltip-v2"
import type { Prompt, ReferenceInfo } from "@newhorse/sdk/v2/client"
...
import { PromptInputV2, type PromptInputV2Suggestion } from "@newhorse/session-ui/v2/prompt-input"
import {
  createPromptInputV2Controller,
  createPromptInputV2State,
  type PromptInputV2Interaction,
} from "@newhorse/session-ui/v2/prompt-input/interaction"
...
export function usePromptInputV2Controller(props: PromptInputV2ControllerProps): PromptInputV2ComposerController {
  ...
  const designPlaceholder = () => promptDesignPlaceholder(mode(), placeholder(), language.t)
  ...
  const submission = createPromptSubmit({
    ...
    newSessionWorkspaceID: () => props.newSessionWorkspaceID,
    newSessionWorkspaceType: () => props.newSessionWorkspaceType,
    newSessionWorkspaceDirectory: () => props.newSessionWorkspaceDirectory,
    newSessionProfileID: () => props.newSessionProfileID,
