export const dict = {
  ...
  "settings.memory.group.current": "Trenutni radni prostor",
  "settings.memory.group.workspace": "Radni prostor {{id}}",
  "settings.memory.group.personal": "Osobno",
  "settings.memory.group.relationship": "Odnos",
  "settings.memory.group.global": "Globalno",
  "settings.memory.group.toggle": "Preklopi grupu",
  "settings.memory.search.placeholder": "Pretraži zapise memorije",
  "settings.memory.search.empty": "Nema zapisa koji odgovaraju pretrazi.",
  ...
  "workbench.presence.gantt": "Današnja vremenska linija fokusa",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "Nema zabilježene aktivnosti u posljednjih 90 dana.",
    "workbench.activity.error": "Neuspješno učitavanje podataka o aktivnosti.",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "provider.custom.field.api.label": "API protokol",
  ...
  "provider.custom.models.fetch": "Dohvati modele",
  "provider.custom.models.fetching": "Dohvaćanje…",
  "provider.custom.models.fetch.needBaseUrl": "Prvo unesite osnovni URL.",
  "provider.custom.models.fetch.needApiKey": "Prvo unesite API ključ.",
  "provider.custom.models.fetch.failed": "Nije moguće dohvatiti modele. Provjerite osnovni URL i API ključ.",
  "provider.custom.models.fetch.none": "Ovaj endpoint nije vratio modele.",
  "provider.custom.models.fetch.filled": "Popunjeno {{count}} modela.",
  ...
  "settings.memory.clear.short": "Očisti",
  ...
  "settings.providers.balance": "Stanje",
