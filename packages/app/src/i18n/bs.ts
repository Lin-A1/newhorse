export const dict = {
  ...
  "settings.memory.all.global": "Globalna memorija",
  "settings.memory.all.workspace": "Memorija radnog prostora",
  "settings.memory.view.global": "Globalna memorija",
  "settings.memory.view.workspace": "Memorija radnog prostora",
  "settings.memory.group.current": "Trenutni radni prostor",
  "settings.memory.group.workspace": "Memorija radnog prostora · {{id}}",
  "settings.memory.group.personal": "Osobno",
  "settings.memory.group.relationship": "Odnos",
  "settings.memory.group.global": "Globalna memorija",
