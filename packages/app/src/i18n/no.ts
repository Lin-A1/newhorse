...
export const dict = {
  ...
  "settings.memory.group.current": "Gjeldende arbeidsområde",
  "settings.memory.group.workspace": "Arbeidsområde {{id}}",
  "settings.memory.group.personal": "Personlig",
  "settings.memory.group.relationship": "Relasjon",
  "settings.memory.group.global": "Global",
  "settings.memory.group.toggle": "Veksle gruppe",
  "settings.memory.search.placeholder": "Søk i minneregistreringer",
  "settings.memory.search.empty": "Ingen registreringer samsvarer med søket.",
  ...
  "workbench.presence.gantt": "Dagens fokustidslinje",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "Ingen aktivitet registrert de siste 90 dagene.",
    "workbench.activity.error": "Kunne ikke laste inn aktivitetsdata.",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "provider.custom.models.fetch.needBaseUrl": "Skriv inn Base URL først.",
  "provider.custom.models.fetch.needApiKey": "Skriv inn API-nøkkel først.",
  "provider.custom.models.fetch.failed": "Kunne ikke hente modeller. Sjekk Base URL og API-nøkkel.",
  "provider.custom.models.fetch.none": "Dette endepunktet returnerte ingen modeller.",
  "provider.custom.models.fetch.filled": "Fylt ut {{count}} modeller.",
  ...
  "settings.memory.clear.short": "Tøm",
