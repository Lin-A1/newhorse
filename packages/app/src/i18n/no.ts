...
export const dict = {
  ...
  "settings.memory.all.global": "Globalt minne",
  "settings.memory.all.workspace": "Arbeidsområde-minne",
  "settings.memory.view.global": "Globalt minne",
  "settings.memory.view.workspace": "Arbeidsområde-minne",
  "settings.memory.group.current": "Gjeldende arbeidsområde",
  "settings.memory.group.workspace": "Arbeidsområde-minne · {{id}}",
  "settings.memory.group.personal": "Personlig",
  "settings.memory.group.relationship": "Relasjon",
  "settings.memory.group.global": "Globalt minne",
