export const dict = {
  ...
  "settings.memory.all.global": "전역 메모리",
  "settings.memory.all.workspace": "작업 공간 메모리",
  ...
  "settings.memory.group.workspace": "작업 공간 메모리 · {{id}}",
  "settings.memory.group.personal": "개인",
  "settings.memory.group.relationship": "관계",
  "settings.memory.group.global": "전역 메모리",
