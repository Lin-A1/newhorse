...
export const dict = {
  ...
  "sidebar.dailySummary.generate": "立即生成",
  "sidebar.dailySummary.generate.success": "每日總結已生成",
  "sidebar.dailySummary.generate.noActivity": "今天沒有可總結的活動",
  "sidebar.dailySummary.generate.failed": "生成每日總結失敗",
  "sidebar.help": "說明",
