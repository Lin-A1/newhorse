...
export const dict = {
  ...
  "settings.memory.group.current": "目前工作區",
  "settings.memory.group.workspace": "工作區 {{id}}",
  "settings.memory.group.personal": "個人",
  "settings.memory.group.relationship": "陪伴",
  "settings.memory.group.global": "全域",
  "settings.memory.group.toggle": "摺疊/展開群組",
  "settings.memory.search.placeholder": "搜尋記憶紀錄",
  "settings.memory.search.empty": "沒有符合目前搜尋的紀錄。",
  ...
  "workbench.presence.gantt": "今日感知時間軸",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "最近 90 天沒有記錄到活躍資料。",
    "workbench.activity.error": "活躍資料載入失敗。",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "dialog.model.unpaid.freeModels.title": "newhorse 提供的免費模型",
  "dialog.model.unpaid.addMore.title": "從熱門提供者新增更多模型",
  "dialog.model.unpaid.viewMoreProviders": "查看更多 70+ 個提供者",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 newhorse 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Models gateway 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 newhorse 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 newhorse 中使用 {{provider}} 模型。",
  ...
  "provider.custom.field.api.label": "API 協定",
  ...
  "provider.custom.models.fetch.needBaseUrl": "請先填寫 Base URL。",
  "provider.custom.models.fetch.needApiKey": "請先填寫 API Key。",
  "provider.custom.models.fetch.failed": "取得模型失敗，請檢查 Base URL 和 API Key。",
  "provider.custom.models.fetch.none": "此端點未回傳任何模型。",
  "provider.custom.models.fetch.filled": "已填入 {{count}} 個模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 newhorse 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 newhorse...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 newhorse...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 newhorse 已就緒。",
  "wsl.onboarding.opencodeReady": "newhorse 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 newhorse。",
  "wsl.onboarding.installOpencode": "安裝 newhorse",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 newhorse",
  ...
  "wsl.onboarding.wslUnavailable.description": "newhorse 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 newhorse。",
  ...
  "toast.update.description": "newhorse 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 newhorse 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: newhorse 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "newhorse 提供免費模型，你可以立即開始使用。",
  ...
  "settings.memory.clear.short": "清空",
  ...
  "settings.memory.clear.all": "清空全部工作區",
  "settings.memory.filter.clear": "清除篩選",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 newhorse 伺服器。",
  ...
  "settings.general.row.language.description": "變更 newhorse 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 newhorse 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 newhorse 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 newhorse 的主題。",
  ...
  "settings.updates.row.startup.description": "在 newhorse 啟動時自動檢查更新",
  ...
  "settings.profile.memory.description": "選擇陪伴工作階段如何儲存關係記憶。",
  "settings.profile.memory.off": "關閉",
  "settings.profile.memory.ask": "儲存前詢問",
  "settings.profile.memory.auto-safe": "自動儲存安全且明確的記憶",
  "settings.profile.proactive.title": "主動關懷",
  "settings.profile.proactive.description": "允許已訂閱的問候與回訪，預設關閉；使用者建立的提醒仍可正常使用。",
  "settings.profile.proactivePaused.title": "暫停主動訊息",
  "settings.profile.proactivePaused.description": "保留訂閱，但暫停問候與回訪，直到恢復。",
  "settings.profile.quietHours.title": "靜默時段",
  "settings.profile.quietHours.description": "設定開始、結束時間與 IANA 時區，支援跨午夜。",
  "settings.profile.frequency.title": "頻率上限",
  ...
  "session.clear.title": "清空聊天記錄",
  "session.clear.confirm": '清空「{{name}}」的全部聊天記錄？',
  "session.clear.button": "清空聊天記錄",
  "session.clear.failed.title": "清空聊天記錄失敗",
  ...
  "workbench.section.overview": "概覽",
  "session.turn.thinkingOnly": "思考完成但未回覆",
