export const dict = {
  ...
  "settings.memory.all.global": "Pamięć globalna",
  "settings.memory.all.workspace": "Pamięć obszaru roboczego",
  "settings.memory.view.global": "Pamięć globalna",
  "settings.memory.view.workspace": "Pamięć obszaru roboczego",
  "settings.memory.group.current": "Bieżący obszar roboczy",
  "settings.memory.group.workspace": "Pamięć obszaru roboczego · {{id}}",
  "settings.memory.group.personal": "Osobiste",
  "settings.memory.group.relationship": "Relacja",
  "settings.memory.group.global": "Pamięć globalna",
