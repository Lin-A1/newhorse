export const dict = {
  ...
  "settings.memory.group.current": "Bieżący obszar roboczy",
  "settings.memory.group.workspace": "Obszar {{id}}",
  "settings.memory.group.personal": "Osobiste",
  "settings.memory.group.relationship": "Relacja",
  "settings.memory.group.global": "Globalne",
  "settings.memory.group.toggle": "Przełącz grupę",
  "settings.memory.search.placeholder": "Szukaj wpisów pamięci",
  "settings.memory.search.empty": "Brak wpisów pasujących do bieżącego wyszukiwania.",
  ...
  "workbench.presence.gantt": "Dzisiejsza oś czasu fokusu",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "Brak zarejestrowanej aktywności w ciągu ostatnich 90 dni.",
    "workbench.activity.error": "Nie udało się wczytać danych aktywności.",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez newhorse",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w newhorse.",
  ...
  "provider.connect.opencodeZen.line1":
    "Models gateway daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w newhorse.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w newhorse.",
  ...
  "provider.custom.field.api.label": "Protokół API",
  ...
  "provider.custom.models.fetch.needBaseUrl": "Najpierw podaj URL bazowy.",
  "provider.custom.models.fetch.needApiKey": "Najpierw podaj klucz API.",
  "provider.custom.models.fetch.failed": "Nie udało się pobrać modeli. Sprawdź URL bazowy i klucz API.",
  "provider.custom.models.fetch.none": "Ten endpoint nie zwrócił modeli.",
  "provider.custom.models.fetch.filled": "Wypełniono {{count}} modeli.",
  ...
  "dialog.server.description": "Przełącz serwer newhorse, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie newhorse...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie newhorse w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie newhorse...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie newhorse w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj newhorse w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj newhorse",
  "wsl.onboarding.opencodeReadyIn": "newhorse jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "newhorse jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj newhorse w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj newhorse",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "newhorse nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim newhorse będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "newhorse nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz newhorse.",
  ...
  "toast.update.description": "Nowa wersja newhorse ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu newhorse",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: newhorse nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "newhorse zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.memory.clear.short": "Wyczyść",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer newhorse wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla newhorse",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd newhorse na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy newhorse ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw newhorse.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania newhorse",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji newhorse.",
  ...
  "workbench.section.overview": "Przegląd",
  "session.turn.thinkingOnly": "Pomyślał, ale nie odpowiedział",
}
