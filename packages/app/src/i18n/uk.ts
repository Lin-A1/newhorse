export const dict = {
  ...
  "settings.memory.all.global": "Глобальна пам'ять",
  "settings.memory.all.workspace": "Пам'ять робочого простору",
  "settings.memory.view.global": "Глобальна пам'ять",
  "settings.memory.view.workspace": "Пам'ять робочого простору",
  "settings.memory.group.current": "Поточний робочий простір",
  "settings.memory.group.workspace": "Пам'ять робочого простору · {{id}}",
  "settings.memory.group.personal": "Особисте",
  "settings.memory.group.relationship": "Стосунки",
  "settings.memory.group.global": "Глобальна пам'ять",
