export const dict = {
  ...
  "settings.memory.group.current": "مساحة العمل الحالية",
  "settings.memory.group.workspace": "مساحة العمل {{id}}",
  "settings.memory.group.personal": "شخصي",
  "settings.memory.group.relationship": "العلاقة",
  "settings.memory.group.global": "عام",
  "settings.memory.group.toggle": "طي/فتح المجموعة",
  "settings.memory.search.placeholder": "ابحث في سجلات الذاكرة",
  "settings.memory.search.empty": "لا توجد سجلات تطابق البحث الحالي.",
  ...
  "workbench.presence.gantt": "الخط الزمني لليوم",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "لا يوجد نشاط مسجل في آخر 90 يومًا.",
    "workbench.activity.error": "فشل تحميل بيانات النشاط.",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من newhorse",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في newhorse.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في newhorse.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في newhorse.",
  ...
  "provider.custom.field.api.label": "بروتوكول API",
  ...
  "provider.custom.models.fetch.needBaseUrl": "أدخل عنوان القاعدة أولاً.",
  "provider.custom.models.fetch.needApiKey": "أدخل مفتاح API أولاً.",
  "provider.custom.models.fetch.failed": "تعذّر جلب النماذج. تحقق من عنوان القاعدة ومفتاح API.",
  "provider.custom.models.fetch.none": "لم يُرجع هذا الخادم نماذج.",
  "provider.custom.models.fetch.filled": "تم تعبئة {{count}} نماذج.",
  ...
  "dialog.server.description": "تبديل خادم newhorse الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من newhorse...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من newhorse في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث newhorse...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث newhorse في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث newhorse في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث newhorse",
  "wsl.onboarding.opencodeReadyIn": "newhorse جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "newhorse جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت newhorse في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت newhorse",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "newhorse غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن newhorse من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على newhorse التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح newhorse.",
  ...
  "toast.update.description": "نسخة جديدة من newhorse ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق newhorse",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن newhorse لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن newhorse نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.memory.clear.short": "مسح",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم newhorse داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ newhorse",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور newhorse على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان newhorse يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة newhorse.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل newhorse",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من newhorse.",
  ...
  "settings.providers.balance": "الرصيد",
