export const dict = {
  ...
  "settings.memory.all.global": "الذاكرة العامة",
  "settings.memory.all.workspace": "ذاكرة مساحة العمل",
  "settings.memory.view.global": "الذاكرة العامة",
  "settings.memory.view.workspace": "ذاكرة مساحة العمل",
  "settings.memory.group.current": "مساحة العمل الحالية",
  "settings.memory.group.workspace": "ذاكرة مساحة العمل · {{id}}",
  "settings.memory.group.personal": "شخصي",
  "settings.memory.group.relationship": "العلاقة",
  "settings.memory.group.global": "الذاكرة العامة",
