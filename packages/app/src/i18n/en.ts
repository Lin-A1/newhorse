export const dict = {
  ...
  "settings.memory.group.current": "Current workspace",
  "settings.memory.group.workspace": "Workspace {{id}}",
  "settings.memory.group.personal": "Personal",
  "settings.memory.group.relationship": "Relationship",
  "settings.memory.group.global": "Global",
  "settings.memory.group.toggle": "Toggle group",
  "settings.memory.search.placeholder": "Search memory records",
  "settings.memory.search.empty": "No records match the current search.",
...
"workbench.activity": "Activity",
  ...
  "workbench.less": "Less",
  "workbench.more": "More",
  "workbench.activity.empty": "No activity recorded in the last 90 days.",
  "workbench.activity.error": "Failed to load activity data.",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by newhorse",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in newhorse.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Models gateway gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in newhorse.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in newhorse.",
  ...
  "provider.custom.field.api.label": "API protocol",
  ...
  "provider.custom.models.fetch.needBaseUrl": "Enter a Base URL first.",
  "provider.custom.models.fetch.needApiKey": "Enter an API key first.",
  "provider.custom.models.fetch.failed": "Could not fetch models. Check the Base URL and API key.",
  "provider.custom.models.fetch.none": "No models returned by this endpoint.",
  "provider.custom.models.fetch.filled": "Filled {{count}} models.",
  ...
  "prompt.toast.sessionCreateFailed.noServer": "No connected server or project worktree to open.",
  ...
  "dialog.server.description": "Switch which newhorse server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking newhorse...",
  "wsl.onboarding.checkingOpencodeIn": "Checking newhorse in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating newhorse...",
  "wsl.onboarding.updatingOpencodeIn": "Updating newhorse in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update newhorse in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update newhorse",
  "wsl.onboarding.opencodeReadyIn": "newhorse is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "newhorse is ready.",
  "wsl.onboarding.installOpencodeIn": "Install newhorse in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install newhorse",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "newhorse not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before newhorse can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "newhorse could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen newhorse.",
  ...
  "toast.update.description": "A new version of newhorse ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the newhorse team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, newhorse does not support MCP authentication yet.',
  ...
  "help.tabs.drawer.body.sessions":
  ...
  "help.tabs.drawer.body.organize":
  ...
  "help.tabs.drawer.body.worktrees":
  ...
  "sidebar.gettingStarted.line1": "Get started by connecting a provider to use models.",
  ...
  "settings.memory.clear.short": "Clear",
  ...
  "settings.continuity.empty": "No Continuity grants for this source session.",
  ...
  "settings.companionPlan.continuity.empty":
    "No Continuity grants yet. Minimize a source session to propose a handoff for the Companion to review.",
  ...
  "settings.general.row.language.description": "Change the display language for newhorse",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how newhorse looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether newhorse follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how newhorse is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when newhorse launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of newhorse.",
