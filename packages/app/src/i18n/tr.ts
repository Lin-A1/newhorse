...
export const dict = {
  ...
  "settings.memory.all.global": "Genel bellek",
  "settings.memory.all.workspace": "Çalışma alanı belleği",
  "settings.memory.view.global": "Genel bellek",
  "settings.memory.view.workspace": "Çalışma alanı belleği",
  "settings.memory.group.current": "Geçerli çalışma alanı",
  "settings.memory.group.workspace": "Çalışma alanı belleği · {{id}}",
  "settings.memory.group.personal": "Kişisel",
  "settings.memory.group.relationship": "İlişki",
  "settings.memory.group.global": "Genel bellek",
