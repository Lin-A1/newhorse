...
export const dict = {
  ...
  "settings.memory.group.current": "Geçerli çalışma alanı",
  "settings.memory.group.workspace": "Çalışma alanı {{id}}",
  "settings.memory.group.personal": "Kişisel",
  "settings.memory.group.relationship": "İlişki",
  "settings.memory.group.global": "Genel",
  "settings.memory.group.toggle": "Grubu aç/kapat",
  "settings.memory.search.placeholder": "Bellek kayıtlarında ara",
  "settings.memory.search.empty": "Geçerli aramayla eşleşen kayıt yok.",
  ...
  "workbench.presence.gantt": "Bugünün odak zaman çizelgesi",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "Son 90 günde kaydedilmiş etkinlik yok.",
    "workbench.activity.error": "Etkinlik verileri yüklenemedi.",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve newhorse'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Models gateway, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak newhorse'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak newhorse'da {{provider}} modellerini kullanın.",
  ...
  "provider.custom.field.api.label": "API protokolü",
  ...
  "provider.custom.models.fetch.needBaseUrl": "Önce bir Temel URL girin.",
  "provider.custom.models.fetch.needApiKey": "Önce bir API anahtarı girin.",
  "provider.custom.models.fetch.failed": "Modeller alınamadı. Temel URL'yi ve API anahtarını kontrol edin.",
  "provider.custom.models.fetch.none": "Bu uç nokta model döndürmedi.",
  "provider.custom.models.fetch.filled": "{{count}} model eklendi.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi newhorse sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "newhorse kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde newhorse kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "newhorse güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde newhorse güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki newhorse'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "newhorse'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde newhorse hazır.",
  "wsl.onboarding.opencodeReady": "newhorse hazır.",
  "wsl.onboarding.installOpencodeIn": "newhorse'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "newhorse'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "newhorse kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "newhorse'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "newhorse bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından newhorse'u tekrar açın.",
  ...
  "toast.update.description": "newhorse'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı newhorse ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: newhorse henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "newhorse ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "newhorse Masaüstü",
  ...
  "settings.memory.clear.short": "Temizle",
  ...
  "settings.desktop.wsl.description": "newhorse sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "newhorse'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "newhorse'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "newhorse'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "newhorse'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "newhorse başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "newhorse'un en son sürümünü kullanıyorsunuz.",
  ...
  "settings.providers.balance": "Bakiye",
  ...
  "session.turn.thinkingOnly": "Düşündü ama yanıtlamadı",
