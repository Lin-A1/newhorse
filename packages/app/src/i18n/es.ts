export const dict = {
  ...
  "settings.memory.group.current": "Espacio de trabajo actual",
  "settings.memory.group.workspace": "Espacio {{id}}",
  "settings.memory.group.personal": "Personal",
  "settings.memory.group.relationship": "Relación",
  "settings.memory.group.global": "Global",
  "settings.memory.group.toggle": "Alternar grupo",
  "settings.memory.search.placeholder": "Buscar registros de memoria",
  "settings.memory.search.empty": "Ningún registro coincide con la búsqueda.",
  ...
  "workbench.presence.gantt": "Línea de tiempo de hoy",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "No se registró actividad en los últimos 90 días.",
    "workbench.activity.error": "No se pudieron cargar los datos de actividad.",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por newhorse",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en newhorse.",
  ...
  "provider.connect.opencodeZen.line1":
    "Models gateway te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en newhorse.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en newhorse.",
  ...
  "provider.custom.field.api.label": "Protocolo de API",
  ...
  "provider.custom.models.fetch.needBaseUrl": "Introduce primero una URL base.",
  "provider.custom.models.fetch.needApiKey": "Introduce primero una clave de API.",
  "provider.custom.models.fetch.failed": "No se pudieron obtener los modelos. Revisa la URL base y la clave.",
  "provider.custom.models.fetch.none": "Este endpoint no devolvió modelos.",
  "provider.custom.models.fetch.filled": "Se rellenaron {{count}} modelos.",
  ...
  "prompt.toast.sessionCreateFailed.noServer": "No hay servidor conectado ni árbol de trabajo de proyecto para abrir.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de newhorse se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando newhorse...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando newhorse en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando newhorse...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando newhorse en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza newhorse en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar newhorse",
  "wsl.onboarding.opencodeReadyIn": "newhorse está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "newhorse está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala newhorse en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar newhorse",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "newhorse no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que newhorse pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "newhorse no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir newhorse.",
  ...
  "toast.update.description": "Una nueva versión de newhorse ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de newhorse",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, newhorse no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "newhorse incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.memory.clear.short": "Limpiar",
  ...
  "settings.memory.filter.clear": "Clear filters",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor newhorse dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para newhorse",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve newhorse en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si newhorse sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de newhorse.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia newhorse",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de newhorse.",
  ...
  "workbench.section.overview": "Resumen",
  "session.turn.thinkingOnly": "Pensó pero no respondió",
}
