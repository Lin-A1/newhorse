export const dict = {
  ...
  "settings.memory.all.global": "Memoria global",
  "settings.memory.all.workspace": "Memoria del espacio de trabajo",
  "settings.memory.view.global": "Memoria global",
  "settings.memory.view.workspace": "Memoria del espacio de trabajo",
  "settings.memory.group.current": "Espacio de trabajo actual",
  "settings.memory.group.workspace": "Memoria del espacio de trabajo · {{id}}",
  "settings.memory.group.personal": "Personal",
  "settings.memory.group.relationship": "Relación",
  "settings.memory.group.global": "Memoria global",
