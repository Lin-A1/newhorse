export const dict = {
  ...
  "settings.memory.all.global": "Mémoire globale",
  "settings.memory.all.workspace": "Mémoire de l'espace de travail",
  "settings.memory.view.global": "Mémoire globale",
  "settings.memory.view.workspace": "Mémoire de l'espace de travail",
  "settings.memory.group.current": "Espace de travail courant",
  "settings.memory.group.workspace": "Mémoire de l'espace de travail · {{id}}",
  "settings.memory.group.personal": "Personnel",
  "settings.memory.group.relationship": "Relation",
  "settings.memory.group.global": "Mémoire globale",
