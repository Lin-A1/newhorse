export const dict = {
  ...
  "settings.memory.group.current": "Espace de travail courant",
  "settings.memory.group.workspace": "Espace {{id}}",
  "settings.memory.group.personal": "Personnel",
  "settings.memory.group.relationship": "Relation",
  "settings.memory.group.global": "Global",
  "settings.memory.group.toggle": "Replier/déplier le groupe",
  "settings.memory.search.placeholder": "Rechercher dans les enregistrements",
  "settings.memory.search.empty": "Aucun enregistrement ne correspond à la recherche.",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "Aucune activité enregistrée au cours des 90 derniers jours.",
    "workbench.activity.error": "Impossible de charger les données d'activité.",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par newhorse",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans newhorse.",
  ...
  "provider.connect.opencodeZen.line1":
    "Models gateway vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans newhorse.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans newhorse.",
  ...
  "provider.custom.field.api.label": "Protocole API",
  ...
  "provider.custom.models.fetch.needBaseUrl": "Saisissez d'abord une URL de base.",
  "provider.custom.models.fetch.needApiKey": "Saisissez d'abord une clé API.",
  "provider.custom.models.fetch.failed": "Impossible de récupérer les modèles. Vérifiez l'URL et la clé API.",
  "provider.custom.models.fetch.none": "Cet endpoint n'a renvoyé aucun modèle.",
  "provider.custom.models.fetch.filled": "{{count}} modèles remplis.",
  ...
  "dialog.server.description": "Changez le serveur newhorse auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'newhorse...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'newhorse dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'newhorse...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'newhorse dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour newhorse dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour newhorse",
  "wsl.onboarding.opencodeReadyIn": "newhorse est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "newhorse est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez newhorse dans {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "newhorse non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'newhorse puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "newhorse n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez newhorse.",
  ...
  "toast.update.description":
    "Une nouvelle version d'newhorse ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe newhorse",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'newhorse ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "newhorse inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.memory.clear.short": "Effacer",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur newhorse dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour newhorse",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'newhorse sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si newhorse suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'newhorse.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'newhorse",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'newhorse.",
  ...
  "settings.providers.balance": "Solde",
  ...
  "workbench.section.overview": "Aperçu",
  "session.turn.thinkingOnly": "A réfléchi mais sans réponse",
}
