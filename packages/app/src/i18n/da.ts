export const dict = {
  ...
  "settings.memory.group.current": "Nuværende arbejdsområde",
  "settings.memory.group.workspace": "Arbejdsområde {{id}}",
  "settings.memory.group.personal": "Personlig",
  "settings.memory.group.relationship": "Relation",
  "settings.memory.group.global": "Global",
  "settings.memory.group.toggle": "Fold gruppe ud/sammen",
  "settings.memory.search.placeholder": "Søg i memoryposter",
  "settings.memory.search.empty": "Ingen poster matcher den aktige søgning.",
  ...
  "workbench.presence.gantt": "Dagens fokus-tidslinje",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "Ingen aktivitet registreret i de sidste 90 dage.",
    "workbench.activity.error": "Kunne ikke indlæse aktivitetsdata.",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "provider.custom.models.fetch.needBaseUrl": "Angiv Base URL først.",
  "provider.custom.models.fetch.needApiKey": "Angiv API-nøgle først.",
  "provider.custom.models.fetch.failed": "Kunne ikke hente modeller. Kontrollér Base URL og API-nøgle.",
  "provider.custom.models.fetch.none": "Dette endpoint returnerede ingen modeller.",
  "provider.custom.models.fetch.filled": "Udfyldt {{count}} modeller.",
  ...
  "prompt.toast.sessionCreateFailed.noServer": "Ingen tilsluttet server eller projekt-arbejdstræ at åbne.",
  ...
  "settings.memory.clear.short": "Ryd",
