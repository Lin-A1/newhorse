export const dict = {
  ...
  "settings.memory.all.global": "Global hukommelse",
  "settings.memory.all.workspace": "Arbejdsområde-hukommelse",
  "settings.memory.view.global": "Global hukommelse",
  "settings.memory.view.workspace": "Arbejdsområde-hukommelse",
  "settings.memory.group.current": "Nuværende arbejdsområde",
  "settings.memory.group.workspace": "Arbejdsområde-hukommelse · {{id}}",
  "settings.memory.group.personal": "Personlig",
  "settings.memory.group.relationship": "Relation",
  "settings.memory.group.global": "Global hukommelse",
