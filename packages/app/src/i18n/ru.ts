export const dict = {
  ...
  "settings.memory.all.global": "Глобальная память",
  "settings.memory.all.workspace": "Память рабочей области",
  "settings.memory.view.global": "Глобальная память",
  "settings.memory.view.workspace": "Память рабочей области",
  "settings.memory.group.current": "Текущее рабочее пространство",
  "settings.memory.group.workspace": "Память рабочей области · {{id}}",
  "settings.memory.group.personal": "Личное",
  "settings.memory.group.relationship": "Отношения",
  "settings.memory.group.global": "Глобальная память",
