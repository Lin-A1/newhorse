...
export const dict = {
  ...
  "settings.memory.group.current": "Aktueller Arbeitsbereich",
  "settings.memory.group.workspace": "Arbeitsbereich {{id}}",
  "settings.memory.group.personal": "Persönlich",
  "settings.memory.group.relationship": "Beziehung",
  "settings.memory.group.global": "Global",
  "settings.memory.group.toggle": "Gruppe umschalten",
  "settings.memory.search.placeholder": "Memory-Einträge durchsuchen",
  "settings.memory.search.empty": "Keine Einträge entsprechen der aktuellen Suche.",
  ...
  "workbench.presence.gantt": "Heutige Fokus-Zeitleiste",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "In den letzten 90 Tagen wurde keine Aktivität erfasst.",
    "workbench.activity.error": "Aktivitätsdaten konnten nicht geladen werden.",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "provider.custom.field.api.label": "API-Protokoll",
  ...
  "provider.custom.models.fetch.needBaseUrl": "Zuerst eine Basis-URL eingeben.",
  "provider.custom.models.fetch.needApiKey": "Zuerst einen API-Schlüssel eingeben.",
  "provider.custom.models.fetch.failed": "Modelle konnten nicht abgerufen werden. Basis-URL und API-Schlüssel prüfen.",
  "provider.custom.models.fetch.none": "Dieser Endpunkt hat keine Modelle zurückgegeben.",
  "provider.custom.models.fetch.filled": "{{count}} Modelle eingefügt.",
  ...
  "settings.memory.clear.short": "Leeren",
  ...
  "settings.providers.balance": "Guthaben",
