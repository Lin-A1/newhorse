...
export const dict = {
  ...
  "settings.continuity.status.approved": "approved",
  ...
  "settings.companionPlan.memory.empty": "No proposed Memory.",
  ...
  "settings.companionPlan.continuity.empty": "No Continuity grants for this source session.",
