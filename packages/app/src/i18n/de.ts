...
export const dict = {
  ...
  "settings.memory.all.global": "Globaler Speicher",
  "settings.memory.all.workspace": "Arbeitsbereich-Speicher",
  "settings.memory.view.global": "Globaler Speicher",
  "settings.memory.view.workspace": "Arbeitsbereich-Speicher",
  "settings.memory.group.current": "Aktueller Arbeitsbereich",
  "settings.memory.group.workspace": "Arbeitsbereich-Speicher · {{id}}",
  "settings.memory.group.personal": "Persönlich",
  "settings.memory.group.relationship": "Beziehung",
  "settings.memory.group.global": "Globaler Speicher",
