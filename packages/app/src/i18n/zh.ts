...
export const dict = {
  ...
  "settings.companionPlan.memory.empty": "暂无待处理的记忆。伙伴在对话中请求持久化内容时会出现记忆提议。",
  ...
  "settings.companionPlan.continuity.empty": "暂无连续性授权。最小化一个源会话即可向伙伴提议交接，供其审阅。",
  ...
  "settings.profile.title": "陪伴助手",
  "settings.profile.persona.title": "角色设定",
  "settings.profile.persona.description": "设定陪伴助手的语气与互动风格，安全约束始终受保护。",
  ...
  "settings.profile.crisisRegion.description": "可选。填写你所在的国家或地区，伙伴在需要时可为你提供本地相关的危机支持资源和求助热线。",
  "settings.profile.saved": "陪伴助手设置已保存",
