...
export const dict = {
  "settings.memory.all.count": "条",
  "settings.memory.all.empty": "各工作区暂无记忆。",
  "settings.memory.all.global": "全局偏好",
  "settings.memory.all.workspace": "工作区",
  "settings.memory.view.all": "全部工作区",
  "settings.memory.view.current": "当前工作区",
  "settings.memory.group.current": "当前工作区",
  "settings.memory.group.workspace": "工作区 {{id}}",
  "settings.memory.group.personal": "个人",
  "settings.memory.group.relationship": "陪伴",
  "settings.memory.group.global": "全局",
  "settings.memory.group.toggle": "折叠/展开分组",
  "settings.memory.search.placeholder": "搜索记忆条目",
  "settings.memory.search.empty": "没有匹配当前搜索的记录。",

  "timeline.compaction.messages": "{{count}} 条消息",
  "timeline.compaction.tokens": "{{count}} tokens",
  "workbench.add": "添加",
  "workbench.addTodoPlaceholder": "添加待办…",
  "workbench.dailySummary": "每日总结",
  "workbench.presence.active": "活跃",
  ...
  "workbench.title": "工作台",
  "workbench.todo": "待办",
  "workbench.todoEmpty": "还没有待办。在上面添加，或让 newhorse 帮你记下来。",
  "workbench.toggle": "切换待办状态",
  "workbench.usage": "用量统计",
  "workbench.activity": "活跃度",
  "workbench.activity.empty": "最近 90 天没有记录到活跃数据。",
  "workbench.activity.error": "活跃数据加载失败。",
  "workbench.all": "全部",
  "workbench.days": "天",
  "workbench.less": "少",
  "workbench.more": "多",
  ...
  "provider.custom.field.api.label": "API 协议",
  ...
  "provider.custom.models.fetch.needBaseUrl": "请先填写 Base URL。",
  "provider.custom.models.fetch.needApiKey": "请先填写 API Key。",
  "provider.custom.models.fetch.failed": "获取模型失败，请检查 Base URL 和 API Key。",
  "provider.custom.models.fetch.none": "该接口未返回任何模型。",
  "provider.custom.models.fetch.filled": "已填充 {{count}} 个模型。",
  ...
  "dailyReport.regenerated": "已重新生成每日报告",
  "dailyReport.noActivity": "当天没有活动记录",
  ...
  "settings.memory.clear.all": "清空全部工作区",
  "settings.memory.filter.clear": "清除筛选",
  ...
  "workbench.section.overview": "概览",
  "session.turn.thinkingOnly": "思考完成但未回复",
