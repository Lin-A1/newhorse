...
export const dict = {
  ...
  "sidebar.gettingStarted.line1": "newhorse 提供免费模型，你可以立即开始使用。",
  ...
  "settings.continuity.status.approved": "已批准",
  ...
  "settings.companionPlan.memory.empty": "没有建议的记忆。",
  ...
  "settings.companionPlan.continuity.empty": "当前源会话没有连续性授权。",
  ...
  "settings.profile.crisisRegion.description": "可选，用于提供真实且符合当地情况的危机支持建议。",
