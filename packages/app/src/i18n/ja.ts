export const dict = {
  ...
  "settings.memory.all.global": "グローバルメモリ",
  "settings.memory.all.workspace": "ワークスペースメモリ",
  ...
  "settings.memory.group.workspace": "ワークスペースメモリ · {{id}}",
  "settings.memory.group.personal": "個人",
  "settings.memory.group.relationship": "関係",
  "settings.memory.group.global": "グローバルメモリ",
