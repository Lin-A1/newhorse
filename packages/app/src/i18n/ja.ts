export const dict = {
  ...
  "settings.memory.group.current": "現在のワークスペース",
  "settings.memory.group.workspace": "ワークスペース {{id}}",
  "settings.memory.group.personal": "個人",
  "settings.memory.group.relationship": "関係",
  "settings.memory.group.global": "グローバル",
  "settings.memory.group.toggle": "グループを開閉",
  "settings.memory.search.placeholder": "メモリーレコードを検索",
  "settings.memory.search.empty": "検索に一致するレコードはありません。",
  ...
  "workbench.presence.gantt": "今日のフォーカスタイムライン",
  ...
  "workbench.usage": "Usage",
    ...
    "workbench.activity.empty": "過去90日間に記録されたアクティビティはありません。",
    "workbench.activity.error": "アクティビティデータを読み込めませんでした。",
    "workbench.all": "All",
    "workbench.days": "days",
    "workbench.less": "Less",
    "workbench.more": "More",
  ...
  "dialog.model.unpaid.freeModels.title": "newhorseが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、newhorseで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Models gatewayは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してnewhorseで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、newhorseで{{provider}}モデルを使用してください。",
  ...
  "provider.custom.field.api.label": "API プロトコル",
  ...
  "provider.custom.models.fetch.needBaseUrl": "最初にベースURLを入力してください。",
  "provider.custom.models.fetch.needApiKey": "最初にAPIキーを入力してください。",
  "provider.custom.models.fetch.failed": "モデルを取得できませんでした。ベースURLとAPIキーを確認してください。",
  "provider.custom.models.fetch.none": "このエンドポイントはモデルを返しませんでした。",
  "provider.custom.models.fetch.filled": "{{count}} 個のモデルを入力しました。",
  ...
  "dialog.server.description": "このアプリが接続するnewhorseサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "newhorseを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のnewhorseを確認中...",
  "wsl.onboarding.updatingOpencode": "newhorseを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のnewhorseを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のnewhorseを更新してください。",
  "wsl.onboarding.updateOpencode": "newhorseを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のnewhorseの準備ができました。",
  "wsl.onboarding.opencodeReady": "newhorseの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にnewhorseをインストールしてください。",
  "wsl.onboarding.installOpencode": "newhorseをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "newhorseがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "newhorseでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、newhorseをもう一度開いてください。",
  ...
  "toast.update.description": "newhorseの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをnewhorseチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: newhorseはまだMCP認証をサポートしていません。',
  ...
  "session.header.reveal.containingFolder": "内包するフォルダーを開く",
  ...
  "sidebar.gettingStarted.line1": "newhorseには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.memory.clear.short": "消去",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でnewhorseサーバーを実行します。",
  ...
  "settings.general.row.language.description": "newhorseの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのnewhorseの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "newhorseがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "newhorseのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "newhorse の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "newhorse は最新バージョンです。",
  ...
  "workbench.section.overview": "概要",
  "session.turn.thinkingOnly": "考えたが返答なし",
}
