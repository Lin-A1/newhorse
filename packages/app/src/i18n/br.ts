export const dict = {
  ...
  "settings.memory.all.global": "Memória global",
  "settings.memory.all.workspace": "Memória do espaço de trabalho",
  "settings.memory.view.global": "Memória global",
  "settings.memory.view.workspace": "Memória do espaço de trabalho",
  "settings.memory.group.current": "Espaço de trabalho atual",
  "settings.memory.group.workspace": "Memória do espaço de trabalho · {{id}}",
  "settings.memory.group.personal": "Pessoal",
  "settings.memory.group.relationship": "Relacionamento",
  "settings.memory.group.global": "Memória global",
