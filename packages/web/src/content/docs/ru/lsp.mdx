---
title: LSP-серверы
description: newhorse интегрируется с вашими серверами LSP.
---

newhorse может интегрироваться с серверами Language Server Protocol (LSP), чтобы использовать диагностику как обратную связь для агента.

---

## Встроенные

newhorse поставляется с несколькими встроенными LSP-серверами для популярных языков:
...
Когда LSP включен и newhorse открывает файл, он:
...
Вы можете включить и настроить серверы LSP через раздел `lsp` в конфигурации newhorse.
