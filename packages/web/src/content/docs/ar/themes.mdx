...
مع Newhorse يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Newhorse سمتنا `newhorse`.
...
يأتي Newhorse مع عدة سمات مدمجة.
...
- يريدون أن يطابق Newhorse مظهر terminal لديهم
...
يدعم Newhorse نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/newhorse/themes/*.json` أو `$XDG_CONFIG_HOME/newhorse/themes/*.json`
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.newhorse/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.newhorse/themes/*.json`
