---
title: خوادم LSP
description: يتكامل Newhorse مع خوادم LSP لديك.
---

يمكن أن يتكامل Newhorse مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Newhorse مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح newhorse لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات newhorse.
