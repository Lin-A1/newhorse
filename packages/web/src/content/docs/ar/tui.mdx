---
title: TUI
description: استخدام واجهة المستخدم TUI في Newhorse.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Newhorse واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Newhorse إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Newhorse في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Newhorse. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Newhorse. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `newhorse.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Newhorse بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `newhorse.default`.
