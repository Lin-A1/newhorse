---
title: دعم ACP
description: استخدم Newhorse في أي محرر متوافق مع ACP.
---

يدعم Newhorse بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام Newhorse عبر ACP، اضبط محررك ليشغّل الأمر `newhorse acp`.

يشغّل هذا الأمر Newhorse كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'Newhorse' من محدد الوكلاء في AI Chat.
...
لاستخدام Newhorse كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام Newhorse كوكيل ACP للدردشة.
...
يعمل Newhorse عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات Newhorse
