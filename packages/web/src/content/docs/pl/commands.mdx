...
Utwórz `.newhorse/commands/test.md`:
...
Możesz zdefiniować polecenia w `newhorse.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji newhorse:
...
- Globalnie: `~/.config/newhorse/commands/`
- Na projekt: `.newhorse/commands/`
...
newhorse zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
