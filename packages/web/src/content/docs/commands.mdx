...
Create `.newhorse/commands/test.md`:
...
You can add custom commands through the Newhorse config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Newhorse [config](/docs/config):
...
newhorse includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
