---
title: LSP Servers
description: Newhorse integrates with your LSP servers.
---

Newhorse can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Newhorse comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and newhorse opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your newhorse config.
