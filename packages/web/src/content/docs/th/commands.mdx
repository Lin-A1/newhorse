...
สร้าง `.newhorse/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Newhorse:
...
- ระดับผู้ใช้ (Global): `~/.config/newhorse/commands/`
- ระดับโปรเจ็กต์: `.newhorse/commands/`
...
Newhorse มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
