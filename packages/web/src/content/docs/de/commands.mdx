...
Erstellen Sie `.newhorse/commands/test.md`:

```md title=".newhorse/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Newhorse-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Newhorse [config](/docs/config):

```json title="newhorse.jsonc" {4-12}
{
...
- Global: `~/.config/newhorse/commands/`
- Pro Projekt: `.newhorse/commands/`

```markdown title="~/.config/newhorse/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".newhorse/commands/component.md"
---
...
```md title=".newhorse/commands/create-file.md"
---
...
```md title=".newhorse/commands/analyze-coverage.md"
---
...
```md title=".newhorse/commands/review-changes.md"
---
...
```md title=".newhorse/commands/review-component.md"
---
...
Newhorse enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
