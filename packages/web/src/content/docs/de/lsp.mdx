---
title: LSP Server
description: Newhorse lässt sich in Ihren LSP-Server integrieren.
---

Newhorse kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

Newhorse verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und Newhorse eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Newhorse-Konfiguration aktivieren und anpassen.
