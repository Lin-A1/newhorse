...
Mit Newhorse kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Newhorse das `newhorse`-Theme.
...
Newhorse liefert mehrere eingebaute Themes mit.
...
- Newhorse optisch ans Terminal anpassen wollen
...
Newhorse unterstuetzt ein flexibles JSON-basiertes Theme-System.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/newhorse/themes/*.json` oder `$XDG_CONFIG_HOME/newhorse/themes/*.json`
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.newhorse/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.newhorse/themes/*.json`
