---
title: Teilen
description: Teile Newhorse-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Newhorse-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Newhorse Folgendes:
...
Newhorse hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Newhorse den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`newhorse.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du newhorse in deiner Organisation einsetzt.
