...
description: Verwenden Sie Newhorse in jedem ACP-kompatiblen Editor.
---

Newhorse unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um Newhorse über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `newhorse acp`.

Der Befehl startet Newhorse als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „Newhorse“ in der AI Chat Agent Selector.
...
Um Newhorse als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass Newhorse als ACP-Agent für den Chat verwendet wird.
...
Newhorse funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer Newhorse-Konfiguration konfiguriert sind
