...
Kreiraj `.newhorse/commands/test.md`:
...
Možete dodati prilagođene komande kroz Newhorse konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Newhorse [config](/docs/config):
...
- Globalno: `~/.config/newhorse/commands/`
- Po projektu: `.newhorse/commands/`
...
Newhorse uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
