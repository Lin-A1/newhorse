---
title: TUI
description: Korištenje korisničkog interfejsa Newhorse terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Newhorse pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Newhorse pokreće TUI za trenutni direktorij.
...
Kada koristite Newhorse TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Newhorse. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Newhorse. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `newhorse.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Newhorse čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `newhorse.default`.
