...
Agent skills omogucavaju Newhorse da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Newhorse pretrazuje ove lokacije:

- Konfiguracija projekta: `.newhorse/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/newhorse/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, Newhorse ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.newhorse/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/newhorse/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.newhorse/skills/git-release/SKILL.md` ovako:
...
Newhorse navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `newhorse.json`:
...
**Za ugradene agente** (u `newhorse.json`):
