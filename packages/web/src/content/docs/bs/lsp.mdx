---
title: LSP serveri
description: Newhorse se integriše sa vašim LSP serverima.
---

Newhorse se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Newhorse dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
Kada je LSP omogućen i newhorse otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj newhorse konfiguraciji.
