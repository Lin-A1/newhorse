---
title: ACP podrška
description: Koristite Newhorse u bilo kojem uređivaču kompatibilnom sa ACP.
---

Newhorse podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili Newhorse putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `newhorse acp`.

Naredba pokreće Newhorse kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "Newhorse" agenta u AI Chat agent selektoru.
...
Da koristite Newhorse kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi Newhorse kao ACP chat agenta.
...
Newhorse radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj Newhorse konfiguraciji
