...
Crea `.newhorse/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Newhorse o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Newhorse:
...
- Globale: `~/.config/newhorse/commands/`
- Per progetto: `.newhorse/commands/`
...
newhorse include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
