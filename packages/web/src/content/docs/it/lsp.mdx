---
title: Server LSP
description: Newhorse si integra con i tuoi server LSP.
---

Newhorse può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

Newhorse include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e newhorse apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di newhorse.
