---
title: Supporto ACP
description: Usa Newhorse in qualunque editor compatibile con ACP.
---

Newhorse supporta [Agent Client Protocol](https://agentclientprotocol.com) (ACP), permettendoti di usarlo direttamente in editor e IDE compatibili.
...
Per usare Newhorse via ACP, configura l'editor in modo che esegua il comando `newhorse acp`.

Il comando avvia Newhorse come sottoprocesso compatibile con ACP che comunica con l'editor via JSON-RPC su stdio.
...
Per aprirlo, seleziona il nuovo agente 'Newhorse' nel selettore agenti di AI Chat.
...
Per usare Newhorse come agente ACP in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), aggiungi quanto segue alla config di Neovim:
...
Questa config imposta CodeCompanion per usare Newhorse come agente ACP per la chat.
...
Newhorse funziona via ACP come nel terminale. Tutte le funzionalita sono supportate:
:::note
...
- Server MCP configurati nella tua configurazione Newhorse
