...
`.newhorse/commands/test.md` oluştur:
...
newhorse işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

newhorse [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/newhorse/commands/`
- Proje başına: `.newhorse/commands/`
...
newhorse, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
