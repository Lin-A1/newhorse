---
title: Özel Araçlar
description: LLM'un newhorse'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. newhorse'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.newhorse/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/newhorse/tools/` içine yerleştirerek.
