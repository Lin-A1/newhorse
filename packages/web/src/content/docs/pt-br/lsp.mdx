...
description: O newhorse integra-se aos seus servidores LSP.
---

O newhorse pode se integrar a servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para o agente.

---

## Integrados

O newhorse vem com vários servidores LSP integrados para linguagens populares:
...
Quando o LSP está habilitado e o newhorse abre um arquivo, ele:
...
Você pode habilitar e personalizar os servidores LSP através da seção `lsp` na sua configuração do newhorse.
