---
title: Serveurs LSP
description: Newhorse s'intègre à vos serveurs LSP.
---

Newhorse peut s'intégrer aux serveurs Language Server Protocol (LSP) pour utiliser les diagnostics comme retour pour l'agent.

---

## Serveurs intégrés

Newhorse est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :
...
Lorsque LSP est activé et qu'newhorse ouvre un fichier, il :
...
Vous pouvez activer et personnaliser les serveurs LSP via la section `lsp` de votre configuration newhorse.
