...
description: Créez des outils que le LLM peut appeler dans newhorse.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de newhorse comme `read`, `write` et `bash`.
...
- Localement en les plaçant dans le répertoire `.newhorse/tools/` de votre projet.
- Ou globalement, en les plaçant dans `~/.config/newhorse/tools/`.
