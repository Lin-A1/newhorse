...
Con Newhorse puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Newhorse usa nuestro propio tema `newhorse`.
...
Newhorse viene con varios temas integrados.
...
- Quiere que Newhorse coincida con la apariencia de su terminal
...
Newhorse admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/newhorse/themes/*.json` o `$XDG_CONFIG_HOME/newhorse/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.newhorse/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.newhorse/themes/*.json`
