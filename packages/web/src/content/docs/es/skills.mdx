...
Las habilidades del agente permiten a Newhorse descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Newhorse busca estas ubicaciones:

- Configuración del proyecto: `.newhorse/skills/<name>/SKILL.md`
- Configuración global: `~/.config/newhorse/skills/<name>/SKILL.md`
...
Para las rutas locales del proyecto, Newhorse sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
Carga cualquier `skills/*/SKILL.md` coincidente en `.newhorse/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/newhorse/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.newhorse/skills/git-release/SKILL.md` así:
...
Newhorse enumera las habilidades disponibles en la descripción de la herramienta `skill`.
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `newhorse.json`:
...
**Para agentes integrados** (en `newhorse.json`):
