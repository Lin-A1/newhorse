...
Crear `.newhorse/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Newhorse o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Newhorse [config](/docs/config):
...
- Por proyecto: `.newhorse/commands/`
...
newhorse incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
