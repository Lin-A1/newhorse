---
title: TUI
description: Brug af Newhorse-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Newhorse giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Newhorse starter TUI for den nuværende mappe.
...
Når du bruger Newhorse TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Newhorse. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Newhorse. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `newhorse.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Newhorse venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `newhorse.default`.
