...
description: Brug Newhorse i enhver ACP-kompatibel editor.
---

Newhorse understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge Newhorse via ACP, konfigurer din editor til at køre kommandoen `newhorse acp`.

Kommandoen starter Newhorse som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'Newhorse'-agent i AI Chat-agentvælgeren.
...
For at bruge Newhorse som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge Newhorse som ACP-agent til chat.
...
Newhorse fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din Newhorse-konfiguration
