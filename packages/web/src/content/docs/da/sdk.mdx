...
Brug den til at bygge integrasjoner og kontrollere newhorse programmatisk.
...
Opret en forekomst av newhorse:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `newhorse.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av newhorse, kan du oprete en klientforekomst for at koble til den:
