---
title: LSP-servere
description: Newhorse integreres med dine LSP-servere.
---

Newhorse kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Newhorse leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og newhorse åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din newhorse-konfiguration.
