...
Agentferdigheter lar Newhorse oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
newhorse søker etter disse stedene:

- Prosjektkonfigurasjon: `.newhorse/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/newhorse/skills/<name>/SKILL.md`
...
For prosjektlokale stier går newhorse opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.newhorse/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/newhorse/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.newhorse/skills/git-release/SKILL.md` slik:
...
newhorse viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `newhorse.json`:
...
**For innebygde agenter** (i `newhorse.json`):
