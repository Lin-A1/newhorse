---
title: TUI
description: Bruke newhorse-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Newhorse gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Newhorse starter TUI for gjeldende katalog.
...
Når du bruker Newhorse TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Newhorse. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Newhorse. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `newhorse.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Newhorse venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `newhorse.default`.
