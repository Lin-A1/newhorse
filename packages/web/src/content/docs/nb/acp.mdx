---
title: ACP-støtte
description: Bruk newhorse i en hvilken som helst ACP-kompatibel editor.
---

Newhorse støtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), slik at du kan bruke den direkte i kompatible editorer og IDE-er.
...
For å bruke Newhorse via ACP, konfigurer redigeringsprogrammet til å kjøre kommandoen `newhorse acp`.

Kommandoen starter Newhorse som en ACP-kompatibel underprosess som kommuniserer med editoren din over JSON-RPC via stdio.
...
For å åpne den, bruk den nye 'Newhorse'-agenten i AI Chat-agentvelgeren.
...
For å bruke Newhorse som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), legg til følgende i Neovim-konfigurasjonen:
...
Denne konfigurasjonen setter opp CodeCompanion.nvim til å bruke Newhorse som ACP-agent for chat.
...
Newhorse fungerer på samme måte via ACP som i terminalen. Alle funksjoner støttes:
...
- MCP servere konfigurert i Newhorse-konfigurasjonen
