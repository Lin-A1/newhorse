---
title: LSP-servere
description: newhorse integreres med LSP-serverne dine.
---

Newhorse kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Newhorse kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og newhorse åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Newhorse-konfigurasjonen.
