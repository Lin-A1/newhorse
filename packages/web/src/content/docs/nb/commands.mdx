...
Opprett `.newhorse/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Newhorse-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Newhorse [config](/docs/config):
...
- Per prosjekt: `.newhorse/commands/`
...
Newhorse inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
