...
Det er to typer agenter i Newhorse; primære agenter og underagenter.
...
Newhorse kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Newhorse kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

Newhorse kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `newhorse.json`:
...
Hvis ingen temperatur er spesifisert, bruker Newhorse modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Newhorse-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Newhorse-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Newhorse Zen](/docs/zen), vil du bruke `newhorse/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `newhorse models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/Lin-A1/newhorse).
:::
