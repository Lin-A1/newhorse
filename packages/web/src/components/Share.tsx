...
import { IconNewhorse } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "newhorse/session/message-v2"
import type { Message } from "newhorse/session/message"
import type { Session } from "newhorse/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.newhorse_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.newhorse_name}>
                    <IconNewhorse width={16} height={16} />
                  </div>
