import { OpenCode } from "@newhorse/client/effect"
...
import { createEmbeddedRoutes } from "@newhorse/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@newhorse/sdk-next/OpenCode") {}
