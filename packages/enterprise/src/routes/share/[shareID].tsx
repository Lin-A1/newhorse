import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@newhorse/sdk/v2"
import { SessionTurn } from "@newhorse/session-ui/session-turn"
import { SessionReview } from "@newhorse/session-ui/session-review"
import { DataProvider } from "@newhorse/session-ui/context"
import { FileComponentProvider } from "@newhorse/ui/context/file"
import { WorkerPoolProvider } from "@newhorse/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@newhorse/ui/logo"
import { IconButton } from "@newhorse/ui/icon-button"
import { ProviderIcon } from "@newhorse/ui/provider-icon"
import { iife } from "@newhorse/core/util/iife"
...
import { MessageNav } from "@newhorse/session-ui/message-nav"
import { FileSSR } from "@newhorse/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@newhorse/session-ui/pierre/worker").then((m) => ({
