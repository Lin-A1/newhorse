...
import { Event } from "@newhorse/schema/project-directories"
import { ProjectCopy } from "@newhorse/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@newhorse/ProjectCopy") {}
