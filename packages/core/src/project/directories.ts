...
import type { EffectDrizzleSqlite } from "@newhorse/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@newhorse/ProjectDirectories") {}
