...
import { Entry, FileSystem, FindInput, Match } from "@newhorse/schema/filesystem"
export { Entry, Match, Submatch } from "@newhorse/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@newhorse/v2/FileSystem") {}
