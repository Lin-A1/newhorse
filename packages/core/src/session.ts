...
import { ListAnchor } from "@newhorse/schema/session"
...
import { SessionDurable } from "@newhorse/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@newhorse/v2/Session") {}
