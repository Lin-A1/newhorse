...
import type { Data, Definition, Payload } from "@newhorse/schema/event"
...
export type ID = import("@newhorse/schema/event").ID
export type { Data, Definition, Payload } from "@newhorse/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@newhorse/Event") {}
