...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@newhorse/llm"
...
export class Service extends Context.Service<Service, Interface>()("@newhorse/v2/ToolRegistry") {}
