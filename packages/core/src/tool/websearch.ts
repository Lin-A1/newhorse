...
import { ToolFailure } from "@newhorse/llm"
...
export class ConfigService extends Context.Service<ConfigService, Config>()("@newhorse/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () => {
  const provider = env("OPENCODE_WEBSEARCH_PROVIDER")
