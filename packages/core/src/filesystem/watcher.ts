...
import { FileSystemWatcher } from "@newhorse/schema/filesystem-watcher"
...
export class Service extends Context.Service<Service, Interface>()("@newhorse/v2/FileWatcher") {}
