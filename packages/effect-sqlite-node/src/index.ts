...
export const TypeId: TypeId = "~@newhorse/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@newhorse/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@newhorse/effect-sqlite-node/NodeSqliteClient")
