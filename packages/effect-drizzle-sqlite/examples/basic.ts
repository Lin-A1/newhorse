...
class Database extends Context.Service<Database, DatabaseShape>()("@newhorse/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@newhorse/example/UserStore") {
