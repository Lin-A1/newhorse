...
> current private `@newhorse/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@newhorse/ai`
...
import { LLM } from "@newhorse/ai"
import { OpenAI } from "@newhorse/ai/providers/openai"
...
```ts
import { Message } from "@newhorse/ai"
...
import { LLM, Tool } from "@newhorse/ai"
...
```ts
import { LLM } from "@newhorse/ai/promise"
import { OpenAI } from "@newhorse/ai/providers/openai"
...
```ts
import { LLMSchema } from "@newhorse/ai/schema"
...
```ts
import { Provider, Protocol } from "@newhorse/ai/provider"
...
@newhorse/ai/provider
  experimental Provider and Protocol authoring APIs

@newhorse/ai/providers/openai
@newhorse/ai/providers/anthropic
@newhorse/ai/providers/google
...
```
