import { makeDefaultApi } from "@newhorse/protocol/api"
import { InvalidRequestError, SessionNotFoundError } from "@newhorse/protocol/errors"
import { HttpApiMiddleware } from "effect/unstable/httpapi"

class LocationMiddleware extends HttpApiMiddleware.Service<LocationMiddleware>()(
  "@newhorse/client/LocationMiddleware",
) {}

class SessionLocationMiddleware extends HttpApiMiddleware.Service<SessionLocationMiddleware>()(
  "@newhorse/client/SessionLocationMiddleware",
