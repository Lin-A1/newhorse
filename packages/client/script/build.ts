...
import { compile, emitEffectImported, emitPromise, write } from "@newhorse/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@newhorse/protocol/groups/event"',
            },
          },
        }),
