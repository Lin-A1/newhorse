...
import { llmClient } from "@newhorse/core/effect/app-node-platform"
...
import { LLMClient } from "@newhorse/llm/route"
import type { LLMClientService } from "@newhorse/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@newhorse/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @newhorse/llm. It
