...
import { errorMessage } from "@newhorse/tui/util/error"
import { withTimeout } from "@/util/timeout"
import { withNetworkOptions, resolveNetworkOptionsNoConfig, hasArg } from "@/cli/network"
import { Filesystem } from "@/util/filesystem"
import type { GlobalEvent } from "@newhorse/sdk/v2"
import type { EventSource } from "@newhorse/tui/context/sdk"
import { writeHeapSnapshot } from "v8"
import { ServerAuth } from "@/server/auth"
import { validateSession } from "../tui/validate-session"
import { win32InstallCtrlCGuard } from "@newhorse/tui/terminal-win32"
...
export const TuiThreadCommand = cmd({
  command: "$0 [project]",
  describe: "start newhorse tui",
  builder: (yargs) =>
    withNetworkOptions(yargs)
      .positional("project", {
        type: "string",
        describe: "path to start newhorse in",
      })
      .option("model", {
        type: "string",
        alias: ["m"],
