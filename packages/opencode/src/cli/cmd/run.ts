...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@newhorse/sdk/v2"
...
export const RunCommand = effectCmd({
  command: "run [message..]",
  describe: "run newhorse with a message",
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("attach", {
        type: "string",
        describe: "attach to a running newhorse server (e.g., http://localhost:4096)",
      })
      .option("password", {
        alias: ["p"],
        type: "string",
