...
import type { Event, GlobalEvent, OpencodeClient } from "@newhorse/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@newhorse/RunStreamTransport") {}
