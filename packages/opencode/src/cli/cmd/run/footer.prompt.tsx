...
import { normalizePromptContent } from "@newhorse/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@newhorse/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close newhorse" } satisfies SlashOption,
    ]
