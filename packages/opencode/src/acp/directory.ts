...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@newhorse/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@newhorse/ACPDirectory") {}
