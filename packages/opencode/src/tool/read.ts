...
export const Parameters = Schema.Struct({
  filePath: Schema.String.annotate({
    description:
      "Path to the file or directory to read. Relative paths resolve against the working directory (shown in the environment info); absolute paths are recommended.",
  }),
