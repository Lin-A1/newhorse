...
export const sessionHandlers = HttpApiBuilder.group(InstanceHttpApi, "session", (handlers) =>
  Effect.gen(function* () {
    ...
    const projectedSvc = yield* Projected.Service
    ...
    const projected = Effect.fn("SessionHttpApi.projected")(function* (ctx: {
      params: { sessionID: SessionID }
    }) {
      yield* requireSession(ctx.params.sessionID)
    ...
    const remove = Effect.fn("SessionHttpApi.remove")(function* (ctx: { params: { sessionID: SessionID } }) {
      ...
      if (current.profileID === "companion") return yield* new HttpApiError.BadRequest({})
    ...
    const update = Effect.fn("SessionHttpApi.update")(function* (ctx: {
      ...
      if (ctx.payload.profileID !== undefined) {
        yield* session.setProfile({ sessionID: ctx.params.sessionID, profileID: ctx.payload.profileID })
      }
    ...
    // share/unshare errors are not all client-induced; storage and network
