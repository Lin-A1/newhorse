...
export const exerciseConfigDirectory = path.join(exerciseGlobalRoot, "config", "newhorse")
export const exerciseDataDirectory = path.join(exerciseGlobalRoot, "data", "newhorse")
