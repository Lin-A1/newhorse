...
- Effect plugins import `@newhorse/plugin/v2/effect`, not `@newhorse/core`.
- Public domain values use generated `@newhorse/sdk` types.
...
- Define `PluginHost` domain capabilities in `@newhorse/plugin/v2/effect`.
