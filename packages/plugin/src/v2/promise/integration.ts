...
export interface IntegrationHooks extends Hooks<{ transform: IntegrationDraft }> {
  readonly connection: {
    readonly active: (integrationID: string) => Promise<import("@newhorse/sdk/v2/types").ConnectionInfo | undefined>
    readonly resolve: (
      connection: import("@newhorse/sdk/v2/types").ConnectionInfo,
